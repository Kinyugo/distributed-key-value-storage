defmodule KVServer.Command do
  ...
  ## Examples
    ...
    iex> KVServer.Command.parse("PUT shopping milk 3\r\n")
  ...
  Unknown commands or commands with unknown number of arguments
  return an error

    iex> KVServer.Command.parse("UNKNOWN shopping milk 3\r\n")
    {:error, :unknown_command}

    iex> KVServer.Command.parse("CREATE shopping 3\r\n")
    {:error, :unknown_command}
